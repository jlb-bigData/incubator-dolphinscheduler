...
<script>
  ...
  export default {
    ...
    created () {
    this.searchParams.startDate = dateFormat("YYYY-mm-dd HH:MM:SS", new Date(),-1);
    // end date
    this.searchParams.endDate = dateFormat("YYYY-mm-dd HH:MM:SS", new Date(),0.042);
    },
    mounted () {
      this.$modal.destroy()
  ...
  function dateFormat(fmt, date,days) {
    let ret;
